...
const Lagguges = () => {
    ...
    const handleChange = (e) => {
        ...
        if (name === 'luggage_type') {
            if (value === 'Others') {
                setFormData({ ...formData, luggage_type: value, other_luggage_type: '' });
            } else {
                setFormData({ ...formData, luggage_type: value });
            }
        } else if (name === 'other_luggage_type') {
            setFormData({ ...formData, other_luggage_type: value });
        } else {
                ...
                <form method="post" name="laggugesform" onSubmit={submitForm}>
                    ...
                    <div className="Name">
                        <div className="wrapper-container">
                            <label className="text-label" htmlFor="first_name" id="first_name" aria-hidden="false"> First Name </label>
                    ...
                    <div className="contact">
                        <div className="wrapper-container">
                            ...
                            <input type="tel" id="phone_number" name="phone_number" placeholder="(000) 000-0000" value={formData.phone_number} onChange={handleChange} required />
                        </div>
                        <div className="wrapper-container">
                    ...
                    <div className="Emergency-Contact">
                        <div className="wrapper-container">
                            ...
                            <input type="text" id="emergency_first_name" name="emergency_first_name" value={formData.emergency_first_name} onChange={handleChange} required />
                        </div>
                        <div className="wrapper-container">
                            <label className="text-label" htmlFor="emergency_last_name">Last Name</label>
                            <input type="text" id="emergency_last_name" name="emergency_last_name" value={formData.emergency_last_name} onChange={handleChange} required />
                        </div>
                        <div className="wrapper-container">
                            <label className="text-label" htmlFor="emergency_phone_number">Phone Number</label>
                            <input type="tel" id="emergency_phone_number" name="emergency_phone_number" placeholder="(000) 000-0000" value={formData.emergency_phone_number} onChange={handleChange} required />
                        </div>
                    </div>
                    ...
                    <div className="datetime-input">
                        ...
                        <div className="wrapper-container">
                            <label className="text-label" htmlFor="leave_date">Time</label>
                        ...
                        {[
                            ...
                            <div className="toggle-switch" key={option}>
                                ...
                                <label htmlFor={`toggle_${option.toLowerCase().replace(' ', '')}`} className="toggle-label">
                                    {option}
                                    {option === 'Others' && (
                                        <input type="text" id="other_luggage_type" name="other_luggage_type" placeholder="Please specify" value={formData.other_luggage_type} onChange={handleChange}  />
                                    )}
                                </label>
                            </div>
                        ))}
